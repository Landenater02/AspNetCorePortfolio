...
using PortfolioSite.Components.PageBuilder.Widgets.NumberWidget;

[assembly: RegisterWidget("Components.Widgets.NumberWidget",
                         "Number selector",
                         typeof(NumberWidgetProperties),
                         customViewName: "~/Components/Widgets/NumberWidget/_NumberWidget.cshtml")]

namespace PortfolioSite.Components.PageBuilder.Widgets.NumberWidget
{
